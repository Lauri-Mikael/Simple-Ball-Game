...
def display_moving_objects(statelist):
    ...
    # Draw Characters
    if statelist[0] == 0:
        window.blit(leftchar_image, (180, 600))
    elif statelist[0] == 1:
        window.blit(leftchar_kick1_image, (180, 600))
    elif statelist[0] == 2:
        window.blit(leftchar_kick2_image, (180, 600))

    if statelist[1] == 0:
        window.blit(rightchar_image, (1050, 600))
    elif statelist[1] == 1:
        window.blit(rightchar_kick1_image, (1050, 600))
    elif statelist[1] == 2:
        window.blit(rightchar_kick2_image, (1050, 600))
    ...
    while True:
        ...
        while running:
            for event in pygame.event.get():
                ...
                if event.type == pygame.KEYDOWN:
                    if event.key == pygame.K_a:
                        ...
                        pygame.time.set_timer(CUSTOM_EVENT1, 2600)
                        update_score_triggeredl = False
                    elif event.key == pygame.K_s:
                        if not update_score_triggeredl:
                            break
                        left_event_time = pygame.time.get_ticks()
                        pygame.time.set_timer(CUSTOM_EVENT5, 2600)
                        update_score_triggeredl = False
                    elif event.key == pygame.K_d:
                        if not update_score_triggeredl:
                            break
                        left_event_time = pygame.time.get_ticks()
                        pygame.time.set_timer(CUSTOM_EVENT10, 2600)
                        update_score_triggeredl = False
                    elif event.key == pygame.K_l:
                        if not update_score_triggeredr:
                            break
                        right_event_time = pygame.time.get_ticks()
                        pygame.time.set_timer(CUSTOM_EVENT11, 2600)
                        update_score_triggeredr = False
                    elif event.key == pygame.K_k:
                        if not update_score_triggeredr:
                            break
                        right_event_time = pygame.time.get_ticks()
                        pygame.time.set_timer(CUSTOM_EVENT51, 2600)
                        update_score_triggeredr = False
                    elif event.key == pygame.K_j:
                        if not update_score_triggeredr:
                            break
                        right_event_time = pygame.time.get_ticks()
                        pygame.time.set_timer(CUSTOM_EVENT101, 2600)
                        update_score_triggeredr = False

                if event.type == CUSTOM_EVENT1 and not update_score_triggeredl:
                    if pygame.time.get_ticks() - left_event_time >= 2600:
                        update_score(1, team1_score + 1)
                        update_current_score(1, 1)
                        update_score_triggeredl = True
                if event.type == CUSTOM_EVENT5 and not update_score_triggeredl:
                    if pygame.time.get_ticks() - left_event_time >= 2600:
                        update_score(1, team1_score + 5)
                        update_current_score(1, 5)
                        update_score_triggeredl = True
                if event.type == CUSTOM_EVENT10 and not update_score_triggeredl:
                    if pygame.time.get_ticks() - left_event_time >= 2600:
                        update_score(1, team1_score + 10)
                        update_current_score(1, 10)
                        update_score_triggeredl = True

                if event.type == CUSTOM_EVENT11 and not update_score_triggeredr:
                    if pygame.time.get_ticks() - right_event_time >= 2600:
                        update_score(2, team2_score + 1)
                        update_current_score(2, 1)
                        update_score_triggeredr = True
                if event.type == CUSTOM_EVENT51 and not update_score_triggeredr:
                    if pygame.time.get_ticks() - right_event_time >= 2600:
                        update_score(2, team2_score + 5)
                        update_current_score(2, 5)
                        update_score_triggeredr = True
                if event.type == CUSTOM_EVENT101 and not update_score_triggeredr:
                    if pygame.time.get_ticks() - right_event_time >= 2600:
            ...
            if left_event_time == -1:
                ...
                statelist[0] = 2
            elif pygame.time.get_ticks() - left_event_time < 2600:
                statelist[0] = 0
            ...
            if right_event_time == -1:
                ...
                statelist[1] = 2
            elif pygame.time.get_ticks() - right_event_time < 2600:
                statelist[1] = 0
